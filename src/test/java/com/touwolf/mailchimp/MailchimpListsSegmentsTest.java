...
import com.touwolf.mailchimp.api.lists.ListsSegments;
...
public class MailchimpListsSegmentsTest {
    ...
    public void testSendgridRequest() throws Exception {
        ...
        try {
            ...
            ListsSegments listsSegments = client.listsSegments();
