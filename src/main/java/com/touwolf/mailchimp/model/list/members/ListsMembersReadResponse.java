...
public class ListsMembersReadResponse {
    private List<ListsMembersResponse> members;
     ...
     */
    public List<ListsMembersResponse> getMembers() {
        return members;
    }

    public void setMembers(List<ListsMembersResponse> members) {
