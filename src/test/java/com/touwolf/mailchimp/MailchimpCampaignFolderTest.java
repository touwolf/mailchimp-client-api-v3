...
import com.touwolf.mailchimp.api.campaign.CampaignFolder;
...
public class MailchimpCampaignFolderTest {
    ...
    public void testSendgridRequest() throws Exception {
        ...
        try {
            ...
            CampaignFolder campaignFolder = client.campaignFolder();
